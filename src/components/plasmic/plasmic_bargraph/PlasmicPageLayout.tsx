...
// Plasmic Project: bPLPidFvwBso7JoxbRKwxt
// Component: rML5ynE3WzY2
...
import projectcss from "./plasmic.module.css"; // plasmic-import: bPLPidFvwBso7JoxbRKwxt/projectcss
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: rML5ynE3WzY2/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: d5hLCpIRXikX/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: mtKmDyvwo8dO/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__kZh3B)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__uKfbZ)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__ribb3)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__yAxm8)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__vp2J2)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
